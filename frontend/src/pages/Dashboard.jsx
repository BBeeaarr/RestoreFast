  ...
  return (
    <div className="container">
      <div style={{ marginBottom: '1rem' }}>
        <Link to={`/projects/${id}`} style={{ color: '#646cff', textDecoration: 'none' }}>
          ← Back to Project
        </Link>
      </div>

      <h2 style={{ marginBottom: '0.5rem' }}>{project.name} - Dashboard</h2>
      <p style={{ color: '#666', marginBottom: '2rem' }}>{project.address}</p>
